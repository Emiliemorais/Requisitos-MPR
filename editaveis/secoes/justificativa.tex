...
Segundo \citeonline{alves}, ``as metodologias tradicionais têm uma orientação
...
\citeonline{alves} relatam que os valores ágeis estão alinhados com dinâmicas de pequenas e médias organizações.
...
Os processos ágeis são caracterizados por \citeonline{pressman} como processos
...
\citeonline{safe} afirma que a metodologia ágil se concentra em dois aspectos principais: 
...
em grandes projetos e possui papéis muito bem definidos, como analisado por \citeonline{vasco}. Já o SAFe e o Scrum permitem uma maior dinâmica na equipe.
...
fundamentais da ER. E de acordo com \citeonline{safe}, foi um modelo criado para suportar a necessidade de \textit{feedback}
...
Reunião de Retrospectiva da \textit{Sprint}, como proposto por \citeonline{scrum}.
